...
export default function ServicesPage() {
  return (
    <>
      <section className="py-12 px-8 md:px-32 md:py-16 lg:py-20 flex-col justify-center items-center w-full">
        <div className="container">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <Badge className="mb-4">Our Services</Badge>
            <h1 className="text-xl md:text-5xl font-bold tracking-tight mb-4">
              Professional Plumbing Services
            </h1>
            <p className="text-lg text-muted-foreground">
              From emergency repairs to complete bathroom remodels, our expert
              plumbers have you covered with reliable solutions.
            </p>
          </div>
          ...
          <Tabs defaultValue="all" className="w-full text-center">
                ...
                {services.map((service) => (
                  ...
                  >
                    <CardHeader>
                      ...
                      <CardTitle className={"text-[1.4rem] mb-6"}>
                        {service.title}
                      </CardTitle>
            ...
            <TabsContent value="residential" className="mt-0">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {services
                  .filter((s) =>
                    ["leaks", "water-heater", "bathroom", "drains"].includes(
                      s.id,
                    ),
                  )
                  .map((service) => (
            ...
            <TabsContent value="commercial" className="mt-0">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {services
                  .filter((s) =>
                    ["maintenance", "drains", "leaks"].includes(s.id),
                  )
                  .map((service) => (
                    <Card
                      key={service.id}
            ...
            <TabsContent value="emergency" className="mt-0">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {services
                  .filter((s) =>
                    ["emergency", "leaks", "water-heater"].includes(s.id),
                  )
                  .map((service) => (
                    <Card
                      key={service.id}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground">
                ...
                the initial contact to the completion of your plumbing project.
              </p>
              ...
              <div className="space-y-8 pt-4">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Reach out via phone, email, or our online form to schedule
                      a service or consultation.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Our technicians will assess the situation and provide a
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Our expert plumbers complete the work efficiently and to
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      We follow up to ensure your satisfaction and stand behind
                      our work with a solid guarantee.
                    </p>
                  </div>
                </div>
              </div>
